...
c;a.destroy();for(b in this)this.hasOwnProperty(b)&&"isDestroyed"!==b&&"id"!==b&&(c=Object.getOwnPropertyDescriptor(this,b),c.get||c.set||"function"!==typeof this[b]?delete this[b]:this[b]=O)};this.isDestroyed=function(){return a.isDestroyed};this.isReady=function(){return a.ready}};aa=function(b,d,e){function q(a,b,d,e){var y=A[a];if(y.definition)if(y=y.definition.call(p,b,d,e))y=c(c({},A[a]),y);else return null;return y}function f(a){return p.source===a}var h=e||{},k=void 0===h.flip?!0:h.flip,u=
h.width,g=h.height,n=!1,p=this,r=!1,m,K;I.call(this);if(b&&"string"!==typeof b||!d&&0!==d)e&&"object"===typeof e||(e=d),d=b;"string"===typeof d&&isNaN(d)&&(d=a(d,["canvas","img","video"]));"string"===typeof b&&A[b]&&(K=q(b,d,e,!0))&&(this.hook=b,r=!0,n=K.deferTexture,this.plugin=K,this.compare=K.compare,this.checkDirty=K.checkDirty,K.source&&(d=K.source));if(!K&&d instanceof HTMLElement)"CANVAS"===d.tagName?(this.width=d.width,this.height=d.height,this.render=this.renderImageCanvas,r=!0,this.hook=
"canvas",this.compare=f):"IMG"===d.tagName&&(this.width=d.naturalWidth||1,this.height=d.naturalHeight||1,d.complete&&d.naturalWidth||(n=!0),d.addEventListener("load",function(){if(!p.isDestroyed){if(p.width!==d.naturalWidth||p.height!==d.naturalHeight)p.width=d.naturalWidth,p.height=d.naturalHeight,p.resize();p.setDirty();p.setReady()}},!0),this.render=this.renderImageCanvas,r=!0,this.hook="image",this.compare=f);else if(!K&&d instanceof WebGLTexture){if(s&&!s.isTexture(d))throw Error("Not a valid WebGL texture.");
isNaN(u)?isNaN(g)||(u=g):isNaN(g)&&(g=u);this.width=u;this.height=g;void 0===h.flip&&(k=!1);r=!0;this.texture=d;this.initialized=!0;this.hook="texture";this.compare=f;this.render=function(){}}if(!r&&!K)for(m in A)if(A.hasOwnProperty(m)&&A[m]&&(K=q(m,d,e,!1))){this.hook=m;r=!0;n=K.deferTexture;this.plugin=K;this.compare=K.compare;this.checkDirty=K.checkDirty;K.source&&(d=K.source);break}if(!r)throw Error("Unknown source type");this.source=d;void 0===this.flip&&(this.flip=k);this.targets=[];n||p.setReady();
...
ba=function(a,b,d){function e(a,b,d,q){var f=H[a];if(f.definition){f=f.definition.call(g,b,d,q);if(!f)return null;f=c(c({},H[a]),f);g.hook=G;m=!0;g.plugin=f;g.compare=f.compare;f.gl&&!g.gl&&(g.gl=f.gl,s||k(f.gl));g.gl===s&&(g.model=V,g.shader=X)}return f}var h,f,u,g=this,m=!1,K,v,z,t,G;I.call(this);if(a&&"string"!==typeof a||!b&&0!==b)d&&"object"===typeof d||(d=b),b=a;d=d||{};h=void 0===d.flip?!0:d.flip;f=parseInt(d.width,10);u=parseInt(d.height,10);v=d.debugContext;"string"===typeof a&&H[a]&&e(a,
b,d,!0);this.renderToTexture=d.renderToTexture;if(b instanceof WebGLFramebuffer)if(z=b,d instanceof HTMLCanvasElement)b=d;else if(d instanceof WebGLRenderingContext)b=d.canvas;else if(d.canvas instanceof HTMLCanvasElement)b=d.canvas;else if(d.context instanceof WebGLRenderingContext)b=d.context.canvas;else throw Error("Must provide a canvas with WebGLFramebuffer target");if(b instanceof HTMLElement&&"CANVAS"===b.tagName){f=b.width;u=b.height;if(!s||s.canvas!==b&&d.allowSecondaryWebGL)K=l(b,{alpha:!0,
...
p.logger.log("Unable to access cross-domain image"):p.logger.error("Error drawing image to canvas: "+f.message),!1}}return!0},hslToRgb:e,colors:R,setTimeoutZero:g,ShaderProgram:r,FrameBuffer:n,requestAnimationFrame:ta,shader:{makeNoise:"float makeNoise(float u, float v, float timer) {\n\tfloat x = u * v * mod(timer * 1000.0, 100.0);\n\tx = mod(x, 13.0) * mod(x, 127.0);\n\tfloat dx = mod(x, 0.01);\n\treturn clamp(0.1 + dx * 100.0, 0.0, 1.0);\n}\n",random:"#ifndef RANDOM\n#define RANDOM\nfloat random(vec2 n) {\n\treturn 0.5 + 0.5 * fract(sin(dot(n.xy, vec2(12.9898, 78.233)))* 43758.5453);\n}\n#endif\n"}};
p.source("video",function(a,c,d){function e(){a.removeEventListener("loadedmetadata",e,!0);if(!r)if(a.videoWidth){if(g.width!==a.videoWidth||g.height!==a.videoHeight)g.width=a.videoWidth,g.height=a.videoHeight,g.resize();m&&g.setReady()}else m=!0,setTimeout(e,50)}function h(){l=!0}function f(){l=!1;g.setDirty()}var g=this,k,n,r=!1,m=!1,l=!1,z=0;if(a instanceof b.HTMLVideoElement)return a.readyState?e():(m=!0,a.addEventListener("loadedmetadata",e,!0)),a.addEventListener("seeking",h,!1),a.addEventListener("seeked",
f,!1),{deferTexture:m,source:a,render:function ia(c){var d,e;z=a.currentTime;if(!a.videoHeight||!a.videoWidth)return!1;F?(n||(n=v.createElement("canvas").getContext("2d"),k=n.canvas,k.width=g.width,k.height=g.height),d=k,n.drawImage(a,0,0,g.width,g.height)):d=a;c.bindTexture(c.TEXTURE_2D,g.texture);c.pixelStorei(c.UNPACK_FLIP_Y_WEBGL,g.flip);c.pixelStorei(c.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1);try{c.texImage2D(c.TEXTURE_2D,0,c.RGBA,c.RGBA,c.UNSIGNED_BYTE,d);if(void 0===F){e=c.getError();if(e===c.INVALID_VALUE)return F=
!0,ia(c);F=!1}return!0}catch(h){h.code===b.DOMException.SECURITY_ERR?(g.allowRefresh=!1,p.logger.error("Unable to access cross-domain image")):p.logger.error("Error rendering video source",h)}return!1},checkDirty:function(){return!l&&a.currentTime!==z},compare:function(a){return g.source===a},destroy:function(){r=!0;a.removeEventListener("seeking",h,!1);a.removeEventListener("seeked",f,!1);a.removeEventListener("loadedmetadata",e,!0)}}},{title:"Video"});p.transform("2d",function(a){function b(){function a(b,
c){l[12]=l[0]*b+l[4]*c+l[12];l[13]=l[1]*b+l[5]*c+l[13];l[14]=l[2]*b+l[6]*c+l[14];l[15]=l[3]*b+l[7]*c+l[15]}var l=c.matrix,v,z,t,x,G,w,A,B,u,s;k||p||n||r||m||1!==f||1!==g?(da.identity(l),a(k+e,p+h),r&&(l[4]=r/c.width),m&&(l[1]=m/c.height),n&&(t=l[0],x=l[1],G=l[2],w=l[3],A=l[4],B=l[5],u=l[6],s=l[7],v=-(d?n*Math.PI/180:n),z=Math.sin(v),v=Math.cos(v),l[0]=t*v+A*z,l[1]=x*v+B*z,l[2]=G*v+u*z,l[3]=w*v+s*z,l[4]=A*v-t*z,l[5]=B*v-x*z,l[6]=u*v-G*z,l[7]=s*v-w*z),1!==f&&(l[0]*=f,l[1]*=f,l[2]*=f,l[3]*=f),1!==g&&
(l[4]*=g,l[5]*=g,l[6]*=g,l[7]*=g),a(-e,-h),c.transformed=!0):c.transformed=!1}var c=this,d=!(a&&a.radians),e=0,h=0,f=1,g=1,k=0,p=0,n=0,r=0,m=0;return{inputs:{reset:{method:function(){h=e=0;g=f=1;m=r=n=p=k=0;return c.transformed?(c.transformed=!1,!0):!1}},translate:{method:function(a,c){isNaN(a)&&(a=k);isNaN(c)&&(c=p);if(a===k&&c===p)return!1;k=a;p=c;b();return!0},type:["number","number"]},translateX:{get:function(){return k},set:function(a){if(a===k)return!1;k=a;b();return!0},type:"number"},translateY:{get:function(){return p},
...
"horizontal":"vertical"},set:function(b){b="vertical"===b?!1:!0;if(b===c)return!1;c=b;a();return!0},type:"string"}}}},{title:"Flip",description:"Flip Horizontal/Vertical"});p.transform("reformat",function(){function a(){var b=d.matrix,c=e||d.width,g=h||d.height,k=d.source,p=k&&k.width||1,k=k&&k.height||1,n,r;"distort"===f||c===p&&g===k?d.transformed=!1:(n=p/k,r=c/g,"none"===f?(c=p/c,g=k/g):"width"===f||"contain"===f&&r<=n?(c=1,g=r/n):"height"===f||"contain"===f&&r>n?(c=n/r,g=1):r>n?(c=1,g=r/n):(c=
n/r,g=1),1===c&&1===g?d.transformed=!1:(da.identity(b),1!==c&&(b[0]*=c,b[1]*=c,b[2]*=c,b[3]*=c),1!==g&&(b[4]*=g,b[5]*=g,b[6]*=g,b[7]*=g),d.transformed=!0))}function b(){return e||d.source&&d.source.width||1}function c(){return h||d.source&&d.source.height||1}var d=this,e,h,f="contain";this.resize=function(){var d=b(),e=c();if(this.width!==d||this.height!==e)for(this.width=d,this.height=e,this.uniforms&&this.uniforms.resolution&&(this.uniforms.resolution[0]=d,this.uniforms.resolution[1]=e),this.frameBuffer&&
...
UI.Number=function(b,a,c,d,e,f){this.target=b;this.mouseDown=!1;this.callback=c||function(){};this.content=document.createElement("div");this.content.className="UI-base";b.appendChild(this.content);this.t1=document.createElement("div");this.t1.className="UI-text";this.t1.innerHTML=a+":";this.content.appendChild(this.t1);this.t2=document.createElement("div");this.t2.className="UI-text";this.t2.style.cssText="width:100px; left:100px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";this.t2.contentEditable=
!0;this.t2.innerHTML=d;this.content.appendChild(this.t2);this.fun=function(a){this.callback(this.t2.innerHTML)}.bind(this);this.t2.addEventListener("input",this.fun,!1)};UI.Number.prototype={constructor:UI.Number,clear:function(){this.t2.removeEventListener("input",this.fun,!1);this.content.removeChild(this.t1);this.content.removeChild(this.t2);this.target.removeChild(this.content);this.target=this.content=this.t2=this.t1=this.fun=this.callback=null}};
UI.V2=function(b,a,c,d,e){this.target=b;this.value1=d;this.value2=e;this.mouseDown=!1;this.callback=c||function(){};this.content=document.createElement("div");this.content.className="UI-base";b.appendChild(this.content);this.t1=document.createElement("div");this.t1.className="UI-text";this.t1.innerHTML=a+":";this.content.appendChild(this.t1);this.t2=document.createElement("div");this.t2.className="UI-text";this.t2.style.cssText="width:60px; left:100px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";
this.t2.contentEditable=!0;this.t2.innerHTML=this.value1;this.content.appendChild(this.t2);this.t3=document.createElement("div");this.t3.className="UI-text";this.t3.style.cssText="width:60px; left:170px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";this.t3.contentEditable=!0;this.t3.innerHTML=this.value2;this.content.appendChild(this.t3);this.fun=function(a){this.value1=this.t2.innerHTML;this.value2=this.t3.innerHTML;this.callback([this.value1,this.value2])}.bind(this);this.t2.addEventListener("input",
this.fun,!1);this.t3.addEventListener("input",this.fun,!1)};UI.V2.prototype={constructor:UI.V2,clear:function(){this.t2.removeEventListener("input",this.fun,!1);this.t3.removeEventListener("input",this.fun,!1);this.content.removeChild(this.t1);this.content.removeChild(this.t2);this.content.removeChild(this.t3);this.target.removeChild(this.content);this.target=this.content=this.t3=this.t2=this.t1=this.fun=this.callback=null}};
UI.Color=function(b,a,c,d){this.target=b;this.value1=(255*d[0]).toFixed(0);this.value2=(255*d[1]).toFixed(0);this.value3=(255*d[2]).toFixed(0);this.value4=(255*d[3]).toFixed(0);this.mouseDown=!1;this.callback=c||function(){};this.content=document.createElement("div");this.content.className="UI-base";b.appendChild(this.content);this.t1=document.createElement("div");this.t1.className="UI-text";this.t1.innerHTML=a+":";this.content.appendChild(this.t1);this.t2=document.createElement("div");this.t2.className=
"UI-text";this.t2.style.cssText="width:40px; left:100px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";this.t2.contentEditable=!0;this.t2.innerHTML=this.value1;this.content.appendChild(this.t2);this.t3=document.createElement("div");this.t3.className="UI-text";this.t3.style.cssText="width:40px; left:145px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";this.t3.contentEditable=!0;this.t3.innerHTML=this.value2;this.content.appendChild(this.t3);this.t4=document.createElement("div");
this.t4.className="UI-text";this.t4.style.cssText="width:40px; left:190px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";this.t4.contentEditable=!0;this.t4.innerHTML=this.value3;this.content.appendChild(this.t4);this.t5=document.createElement("div");this.t5.className="UI-text";this.t5.style.cssText="width:40px; left:235px; pointer-events:auto; background:rgba(0,0,0,0.2);  border:none;";this.t5.contentEditable=!0;this.t5.innerHTML=this.value4;this.content.appendChild(this.t5);this.fun=
function(a){this.value1=this.t2.innerHTML;this.value2=this.t3.innerHTML;this.value3=this.t4.innerHTML;this.value4=this.t5.innerHTML;this.callback([this.value1/255,this.value2/255,this.value3/255,this.value4/255])}.bind(this);this.t2.addEventListener("input",this.fun,!1);this.t3.addEventListener("input",this.fun,!1);this.t4.addEventListener("input",this.fun,!1);this.t5.addEventListener("input",this.fun,!1)};
UI.Color.prototype={constructor:UI.Color,clear:function(){this.t2.removeEventListener("input",this.fun,!1);this.t3.removeEventListener("input",this.fun,!1);this.t4.removeEventListener("input",this.fun,!1);this.t5.removeEventListener("input",this.fun,!1);this.content.removeChild(this.t1);this.content.removeChild(this.t2);this.content.removeChild(this.t3);this.content.removeChild(this.t4);this.content.removeChild(this.t5);this.target.removeChild(this.content);this.target=this.content=this.t5=this.t4=
this.t3=this.t2=this.t1=this.fun=this.callback=null}};
...
UI.createClass("UI-box","position:absolute; left:100px; top:2px; width:16px; height:16px; pointer-events:auto; cursor:pointer; border:1px solid #FFF; "+str);UI.createClass("UI-text","font-size:12px; position:absolute; width:80px; height:16px; pointer-events:none; margin-top:2px; padding-left:4px; padding-top:2px; text-align:Left;"+str);
