...
Serious.createClass("S-sideButton","position:absolute; width:30px; height:18px; background:#222; margin-left:-30px; padding-top:3px; border-top-left-radius:4px; border-bottom-left-radius:4px; cursor:pointer; ");Serious.createClass("S-sideButton:hover","background:#AAA; color:#000; ");Serious.createClass("S-sideButton-select:hover","background:#AAA; color:#000; ");Serious.createClass("sideselect"," background:#2A2; color:#fff; ");this.menu=document.createElement("div");this.menu.className="S-menu";
...
"S-sideButton";this.bclose.innerHTML="X";this.bclose.style.top="-255px";this.bclose.style.background="#A55";this.menu.appendChild(this.bclose);this.bclose.onclick=function(a){this.close()}.bind(this);this.optionButton=[];for(var b,a=0;8>a;a++)b=document.createElement("div"),b.className="S-sideButton",b.innerHTML=a,b.style.top=-255+30*(a+1)+"px",b.name=a,this.menu.appendChild(b),b.onclick=function(a){this.leftMenuSelected(a.target.name)}.bind(this),this.optionButton.push(b),this.xprevdecale.push([-40,
-40,-40]),this.tmp.push({nodes:[],links:[]});this.leftMenuSelected(0)},leftMenuSelected:function(b,a){for(var c=this.optionButton.length;c--;)this.optionButton[c].className=b==c?"S-sideButton sideselect":"S-sideButton";a||this.refresh(b)},add:function(b,a,c){c=c||0;a=a||{};var d,e;switch(b){case "camera":e="S";d=this.seriously.source("camera");break;case "texture":e="S";d=this.seriously.source(a.texture,null,{});break;case "video":e="S";d=document.createElement("video");d.autoPlay=!0;d.loop=!0;d.play();
d.url=a.src;break;case "image":e="S";d=document.createElement("img");d.url=a.src;break;case "texture-3D":e="T";d=this.seriously.target(a.texture,{canvas:a.canvas||this.glCanvas});break;case "canvas-3D":e="T";d=this.seriously.target(a.canvas||this.glCanvas);break;case "reformat":e="E";d=this.seriously.transform("reformat");break;default:e="E",d=this.seriously.effect(b)}for(var f in a)"texture"!==f&&"canvas"!==f&&"id"!==f&&"n"!==f&&f in d&&(d[f]=a[f]);f=void 0!==a.id?a.id:this.tmp[c].nodes.length;b=
e+"_"+f+"."+b;if(void 0!==this.tmp[c].nodes[f]){this.tmp[c].nodes[f].node.destroy();switch(e){case "S":this.xprevdecale[c][0]-=this.xDecale;break;case "E":this.xprevdecale[c][1]-=this.xDecale;break;case "T":this.xprevdecale[c][2]-=this.xDecale}console.log("destroy")}var g,k;switch(e){case "S":this.xprevdecale[c][0]+=this.xDecale;g=this.xprevdecale[c][0];k=20;break;case "E":this.xprevdecale[c][1]+=this.xDecale;g=this.xprevdecale[c][1];k=100;break;case "T":this.xprevdecale[c][2]+=this.xDecale,g=this.xprevdecale[c][2],
k=180}this.tmp[c].nodes[f]={n:a.n||e+"_"+f,name:b,node:d,x:g,y:k};return d},addOnAll:function(b,a){for(var c=8;c--;)this.add(b,a,c)},remove:function(){},changeLayer:function(b){this.LAYER=b||0},refreshOnly:function(b){b=b||0;b!==this.LAYER&&(this.LAYER=b,this.applyLinks(),this.leftMenuSelected(b,!0));this.isFirst=!1},refresh:function(b,a){this.clear();b=b||0;if(b!==this.LAYER||a)this.LAYER=b;for(var c=this.tmp[this.LAYER].nodes.length;c--;)this.showNode(this.tmp[this.LAYER].nodes[c].name);this.updateLink();
